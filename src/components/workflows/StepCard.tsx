...
export function JsonBlock({ label, data, defaultOpen = false }: {
  ...
  return (
    <details open={defaultOpen} className="mt-1.5">
      <summary className="cursor-pointer select-none text-body text-neutral-5 hover:text-neutral-3 list-none flex items-center gap-1">
      ...
      <pre className="mt-1 overflow-x-auto rounded-md bg-neutral-12 p-2.5 text-body text-neutral-3 font-mono max-h-64 overflow-y-auto">
        {display}
      </pre>
    </details>
  )
